...
export default function DeleteEventForm({ event }: DeleteEventFormProps) {
  ...
  return (
    <div className="bg-neutral-800 rounded-lg p-6 border border-red-500/20">
      <div className="mb-6">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="text-white">{event.description || "설명 없음"}</p>
          </div>
          {event.link && (
            <div>
      ...
      <div className="mb-6">
        <div className="relative w-full max-w-md aspect-video border-2 border-red-500/30 rounded-lg overflow-hidden">
          <img
            src={event.image}
            alt={event.title}
