                ...
                <tr key={index}>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-10 w-10 bg-gray-200 dark:bg-neutral-700 rounded-lg"></div>
        ...
        {[...Array(10)].map((_, index) => (
          ...
          >
            <div className="flex gap-3 mb-3">
              <div className="flex-shrink-0 h-15 w-15 bg-gray-200 dark:bg-neutral-700 rounded-lg"></div>
              <div className="min-w-0 flex-1">
                ...
                <div className="h-3 bg-gray-200 dark:bg-neutral-700 rounded w-28"></div>
              </div>
            </div>
