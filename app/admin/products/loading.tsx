                ...
                <tr key={index}>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-12 w-12 bg-gray-200 dark:bg-neutral-700 rounded-lg"></div>
          ...
          >
            <div className="flex gap-3 mb-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="h-3 bg-gray-200 dark:bg-neutral-700 rounded w-24 mb-1"></div>
