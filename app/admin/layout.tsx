    ...
    <ThemeProvider>
      <div className="h-full w-full justify-center items-center bg-white dark:bg-neutral-900 transition-colors duration-200">
        <div className="flex flex-col min-h-screen">
          {/* 상단 헤더 */}
          <header className="bg-gray-100 dark:bg-neutral-800 shadow-sm border-b border-gray-200 dark:border-neutral-700 relative">
          ...
          {/* 상단 네비게이션 */}
          <nav className="bg-gray-50 dark:bg-neutral-800 border-b border-gray-200 dark:border-neutral-700">
              ...
              <div className="flex space-x-1 overflow-x-auto">
                {adminMenuItems.map((item) => (
                  <Link
                    key={item.href}
                    href={item.href}
                    className="flex items-center px-4 py-3 text-black dark:text-neutral-300 hover:bg-gray-200 dark:hover:bg-neutral-700 hover:text-orange-500 transition-colors rounded-t whitespace-nowrap text-sm lg:text-base"
                  >
